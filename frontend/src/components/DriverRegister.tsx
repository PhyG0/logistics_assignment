  ...
  return (
    <div className="flex justify-center items-center bg-gray-50">
      <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6">
        <h2 className="text-2xl font-bold mb-4 text-center">Driver Register</h2>
        ...
        <form onSubmit={handleOnRegister} className="flex flex-col gap-4">
          ...
          >
            ...
            <p className="text-center text-sm">Register as User ? <Link to="/user-register" className="text-blue-500">Register</Link></p>
        </form>
