  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {isMapModalOpen && currentDelivery && (
        <div
          className="fixed inset-0 flex items-center justify-center bg-black/50 z-20 p-4"
          onClick={toggleMapModal} // Close modal on clicking outside
        >
          <div
            className="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-5xl h-[80vh] sm:h-[90vh]"
